    ...
    <footer className="bg-black border-t border-gray-800 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <img src="/logo-nobg.png" alt="Enjoy Rent Car Logo" className="h-10 mb-4 object-contain rounded-sm" />
          ...
          <div>
            ...
            <div className="flex gap-4 text-gray-400">
              ...
              <a href="https://www.instagram.com/anas_elazhari10?igsh=dm8xYTVhdTY1dWZk" className="hover:text-red-500 transition"><i className="fab fa-instagram text-lg"></i></a>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Enjoy Rent Car. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
